...
SELECT id AS dimension_id FROM _timescaledb_catalog.dimension WHERE type = 'C' \gset
-- should show MIN_INT/MAX_INT entries
SELECT * FROM _timescaledb_catalog.dimension WHERE type = 'C' AND id = :dimension_id;

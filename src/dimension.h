...
#define FD_DIMENSION_OPEN 'o'
#define FD_DIMENSION_CLOSED 'c'
#define FD_DIMENSION_CORRELATED 'C'
#define FD_DIMENSION_CHECK 'h' /* these are not stored in dimension catalog table */
#define FD_DIMENSION_ANY 'a'
